...
<div class="la-notification" style="left:20%; top:100px; width:70%;">
<?php
$a_id=$_GET['id'];
$qr2="select * from `leave` where id='$a_id' order by time DESC ";
$r1=mysql_query($qr2);
echo mysql_error();    
...
else if ($f_supp=3)
{
  ...
  if($nt['status']==5)
{
  echo "<br/><div style='color:red; float:right;'>DELETED</div>";
}
  ?>
       <br/>
...
echo mysql_error();    
 ...
 <form  action="addcom_a.php?lid=<?php echo $lid; ?>" method="post">
     <textarea value="" name="comment_a" rows="3"><?php echo $nt['comment_a']; ?></textarea><br/>
